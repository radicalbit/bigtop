...
#ln -s $PREFIX/etc/alluxio/conf $PREFIX/$LIB_DIR
install -d -m 0755 $PREFIX/$VAR_DIR/run/alluxio

#cp -ra ${BUILD_DIR}/lib/* $PREFIX/${LIB_DIR}/lib/
cp assembly/target/alluxio-assemblies-1.2.0-rbd-001-jar-with-dependencies.jar $PREFIX/$LIB_DIR
...
export ALLUXIO_JAR="\`find $LIB_DIR/ -name alluxio*.jar|grep -v client\`"
